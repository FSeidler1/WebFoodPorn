...
class DB 
	{
        ...
        function initDB() 
        {
            ...
            $stmt = self::$_db->prepare("CREATE TABLE `fooddb`.`foodporn` ( `id_foodporn` INT NOT NULL AUTO_INCREMENT , 
            `image` TEXT NOT NULL , 
            `title` TEXT NOT NULL , 
            ...
            // Create User Table
            $stmt = self::$_db->prepare("CREATE TABLE `fooddb`.`user` ( `id_user` INT NOT NULL AUTO_INCREMENT , 
            ...
            // Create Like Table
            $stmt = self::$_db->prepare("CREATE TABLE `fooddb`.`like` ( `id_like` INT NOT NULL AUTO_INCREMENT , 
            ...
            $stmt = self::$_db->prepare("CREATE TABLE `fooddb`.`favorit` ( `id_favorit` INT NOT NULL AUTO_INCREMENT , 
            `fs_foodporn` INT NOT NULL , 
            `fs_user` INT NOT NULL , 
